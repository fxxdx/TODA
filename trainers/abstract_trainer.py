...
class AbstractTrainer(object):
   ...
   This class contain the main training functions for our AdAtime
    ...
    def train_model(self):
        ...
        if 'SHOT' in self.da_method:
            self.last_model, self.best_model = self.algorithm.update(self.trg_train_dl, self.loss_avg_meters, self.logger, self.dataset)
        else:
            self.last_model, self.best_model = self.algorithm.update(self.trg_train_dl, self.loss_avg_meters,
                                                                     self.logger)
